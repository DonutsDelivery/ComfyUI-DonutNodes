...
Manual installation links restored from the bundled source catalog. Automatic downloading remains disabled. Place each file at the listed path under ComfyUI.

| Destination | Source |
| --- | --- |
| `models/diffusion_models/krea2_turbo_bf16.safetensors` | [Download](https://huggingface.co/Comfy-Org/Krea-2/resolve/e5ea8b4dd7f38f348b138eb0fe29f92c0e367e96/diffusion_models/krea2_turbo_bf16.safetensors) |
...
| `models/vae/Wan2.1_VAE_upscale2x_imageonly_real_v1.safetensors` | [Download](https://huggingface.co/spacepxl/Wan2.1-VAE-upscale2x/resolve/384fb7de682e60bd54b59d6eea810ca9d9993497/Wan2.1_VAE_upscale2x_imageonly_real_v1.safetensors) · Requires [ComfyUI-VAE-Utils](https://github.com/spacepxl/ComfyUI-VAE-Utils) for optional finetuned decoding. |
...
| `models/diffusion_models/finepornV4INT8NVFP4BF16_v4.safetensors` | [Download](https://civitai.com/api/download/models/3187539?fileId=3068237) |
| `models/loras/krea2/Krea2_NSFW_Aesthetics_V1.safetensors` | [Download](https://civitai.com/api/download/models/3179666?fileId=3060213) |
