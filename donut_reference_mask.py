...
MODES = ["Off", "Auto subject", "Saved mask", "External mask"]
...
class DonutSubjectMaskStudio(_Base):
    ...
    def prepare(self, *args, mask_b_mode="Off", mask_b_model=MODEL_NAME, mask_b_data="",
                mask_b_grow=0, mask_b_feather=0, mask_b_background="Neutral gray", mask_b=None, **kwargs):
...
class DonutSubjectMaskPreview:
    ...
    def preview(self, image_b, model_name, request_id):
