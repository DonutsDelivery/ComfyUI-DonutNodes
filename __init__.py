...
_NODE_MODULES = (
    ...
    "DonutSpectralNoiseSharpener", "DonutKSamplerCFGLinear", "donut_krea2_sda", "donut_grounding_schedule", "donut_lora_civitai",
    ...
    "donut_upscale_stage", "donut_prompt_injection_recursive", "donut_grouped_merge", "DonutEditStudio", "donut_reference_mask", "donut_inpaint",
)
_REQUIRED_OVERRIDES = {
    ...
    "donut_krea2_fusion_experiments": ("DonutKrea2FusionControl",),
    ...
    "donut_reference_mask": ("DonutEditStudio",),
}
